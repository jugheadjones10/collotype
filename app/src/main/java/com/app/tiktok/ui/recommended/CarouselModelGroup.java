...
//
//public class CarouselModelGroup<T> extends EpoxyModelGroup {
//    public final List<T> data;
//
//    public CarouselModelGroup(List<T> carousel, long id) {
//        super(R.layout.model_carousel_group, buildModels(carousel));
//        this.data = carousel;
//        id(id);
//    }
//
//    private static <T> List<EpoxyModel<?>> buildModels(List<T> carousel) {
